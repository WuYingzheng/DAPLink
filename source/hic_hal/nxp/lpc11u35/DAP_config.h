...
*/
static __attribute__((always_inline)) inline uint32_t PIN_SWCLK_TCK_IN(void)
{
...
*/
static __attribute__((always_inline)) inline void     PIN_SWCLK_TCK_SET(void)
{
    LPC_GPIO->SET[PIN_SWCLK_PORT] = PIN_SWCLK;
}
...
*/
static __attribute__((always_inline)) inline void     PIN_SWCLK_TCK_CLR(void)
{
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_SWDIO_TMS_IN(void)
{
...
*/
static __attribute__((always_inline)) inline void     PIN_SWDIO_TMS_SET(void)
{
    LPC_GPIO->SET[PIN_SWDIO_PORT] = PIN_SWDIO;
}
...
*/
static __attribute__((always_inline)) inline void     PIN_SWDIO_TMS_CLR(void)
{
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_SWDIO_IN(void)
{
    return LPC_GPIO->B[PIN_SWDIO_BIT + PIN_SWDIO_PORT * 32] & 0x1;
}
...
*/
static __attribute__((always_inline)) inline void     PIN_SWDIO_OUT(uint32_t bit)
{
    if (bit & 0x1) {
        LPC_GPIO->SET[PIN_SWDIO_PORT] = PIN_SWDIO;
    } else {
...
*/
static __attribute__((always_inline)) inline void     PIN_SWDIO_OUT_ENABLE(void)
{
    LPC_GPIO->DIR[PIN_SWDIO_PORT]  |= PIN_SWDIO;
}
...
*/
static __attribute__((always_inline)) inline void     PIN_SWDIO_OUT_DISABLE(void)
{
    LPC_GPIO->DIR[PIN_SWDIO_PORT]  &= ~(PIN_SWDIO);
}
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_TDI_IN(void)
{
#if (DAP_JTAG != 0)
...
*/
static __attribute__((always_inline)) inline void     PIN_TDI_OUT(uint32_t bit)
{
#if (DAP_JTAG != 0)
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_TDO_IN(void)
{
#if (DAP_JTAG != 0)
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_nTRST_IN(void)
{
    return (0);   // Not available
}
...
*/
static __attribute__((always_inline)) inline void     PIN_nTRST_OUT(uint32_t bit)
{
    ;             // Not available
}
...
*/
static __attribute__((always_inline)) inline uint32_t PIN_nRESET_IN(void)
{
...
*/
static __attribute__((always_inline)) inline void     PIN_nRESET_OUT(uint32_t bit)
{
#if !defined(PIN_nRESET_FET_DRIVE)
    // open drain logic
    if (bit) {
