...
/* Functions that should be provided by user to use standard Virtual COM port
   functionality                                                              */
__attribute__((weak)) int32_t USBD_CDC_ACM_PortInitialize(void)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_PortUninitialize(void)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_PortReset(void)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_PortSetLineCoding(CDC_LINE_CODING *line_coding)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_PortGetLineCoding(CDC_LINE_CODING *line_coding)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_PortSetControlLineState(uint16_t ctrl_bmp)
{
    return (0);
}
...
__attribute__((weak)) int32_t USBD_CDC_ACM_DataReceived(int32_t len)
{
    return (0);
}
...
__attribute__((weak)) int32_t USBD_CDC_ACM_SendEncapsulatedCommand(void)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_GetEncapsulatedResponse(void)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_SetCommFeature(uint16_t feat)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_GetCommFeature(uint16_t feat)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_ClearCommFeature(uint16_t feat)
{
    return (0);
}
__attribute__((weak)) int32_t USBD_CDC_ACM_SendBreak(uint16_t dur)
{
    return (0);
}
...
__attribute__((weak)) int32_t USBD_CDC_ACM_Initialize(void)
{
    data_send_access            = 0;
    data_send_active            = 0;
    data_send_zlp               = 0;
...
__attribute__((weak)) int32_t USBD_CDC_ACM_Uninitialization(void)
{
...
__attribute__((weak)) int32_t USBD_CDC_ACM_Reset(void)
{
    data_send_access            = 0;
    data_send_active            = 0;
    data_send_zlp               = 0;
...
__attribute__((weak)) int32_t USBD_CDC_ACM_SetLineCoding(void)
{
...
__attribute__((weak)) int32_t USBD_CDC_ACM_GetLineCoding(void)
{
...
__attribute__((weak)) int32_t USBD_CDC_ACM_SetControlLineState(uint16_t ctrl_bmp)
{
...
__attribute__((weak)) void USBD_CDC_ACM_EP_INTIN_Event(uint32_t event)
{
