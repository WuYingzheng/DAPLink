...
extern void usbd_msc_read_sect(uint32_t sector, uint8_t *buf, uint32_t num_of_sectors);
// extern void  usbd_msc_write_sect(U32 block, U8 *buf, U32 num_of_blocks);
extern void usbd_msc_write_sect(uint32_t sector, uint8_t *buf, uint32_t num_of_sectors);
