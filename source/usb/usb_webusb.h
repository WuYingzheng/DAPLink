...
typedef struct _WEBUSB_PLATFORM_CAPABILITY_DESCRIPTOR {
    U8  bLength;
    U8  bDescriptorType;
    ...
    U8  bVendorCode;
    U8  iLandingPage;
} __packed WEBUSB_PLATFORM_CAPABILITY_DESCRIPTOR;

typedef struct _WEBUSB_URL_DESCRIPTOR {
    U8  bLength;
    U8  bDescriptorType;
    U8  bScheme;
    char URL[];
} __packed WEBUSB_URL_DESCRIPTOR;
