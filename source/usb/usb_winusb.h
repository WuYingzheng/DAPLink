...
typedef struct _WINUSB_PLATFORM_CAPABILITY_DESCRIPTOR {
    U8  bLength;
    U8  bDescriptorType;
    ...
    U8  bVendorCode;
    U8  bAltEnumCode;
} __attribute__((__packed__)) WINUSB_PLATFORM_CAPABILITY_DESCRIPTOR;

/* WinUSB Microsoft OS 2.0 descriptor set header */
typedef struct _WINUSB_DESCRIPTOR_SET_HEADER {
    U16 wLength;
    U16 wDescriptorType;
    U32 dwWindowsVersion;
    U16 wTotalLength;
} __attribute__((__packed__)) WINUSB_DESCRIPTOR_SET_HEADER;
