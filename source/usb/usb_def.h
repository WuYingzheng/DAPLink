...
} __attribute__((__packed__)) REQUEST_TYPE;
...
typedef struct _USB_SETUP_PACKET  {
    ...
    U16          wLength;                 /* wLength */
} __attribute__((__packed__))USB_SETUP_PACKET;
...
typedef struct _USB_INTERFACE_ASSOCIATION_DESCRIPTOR {
    ...
    U8  iFunction;
} __attribute__((__packed__)) USB_INTERFACE_ASSOCIATION_DESCRIPTOR;

/* USB Binary Object Store Descriptor */
typedef struct _USB_BINARY_OBJECT_STORE_DESCRIPTOR {
    U8  bLength;
    U8  bDescriptorType;
    U16 wTotalLength;
    U8  bNumDeviceCaps;
} __attribute__((__packed__)) USB_BINARY_OBJECT_STORE_DESCRIPTOR;
...
typedef struct _UNION_FUNCTIONAL_DESCRIPTOR {
    ...
    U8  bMasterInterface;
    U8  bSlaveInterface0;
} __attribute__((__packed__)) UNION_FUNCTIONAL_DESCRIPTOR;

typedef struct _WINUSB_FUNCTION_SUBSET_HEADER {
    U16 wLength;
    U16 wDescriptorType;
    U8  bFirstInterface;
    U8  bReserved;
} __attribute__((__packed__)) WINUSB_FUNCTION_SUBSET_HEADER;
...
} __attribute__((__packed__)) USB_DEVICE_CAPABILITY_DESCRIPTOR;
