...
#
# 生成 git 版本库信息 source/daplink/version_git.h
#
...
def generate_version_file(version_git_dir):
    ...
    try:
        ...
        print("#> ERROR: Failed to get git SHA, do you have git in your PATH environment variable?")
        return 1
...
if __name__ == "__main__":
    ...
    daplink = tool_path + "/../source/daplink/"
    parser = argparse.ArgumentParser(description='git version generator')
    parser.add_argument("--version_git_dir", type=str, default=daplink,
        help="directory to output version_git.h file")
